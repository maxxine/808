...
// Copyright (c) 2014 The 808 developers
...
// for both 808d and 808(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of 808 releases, the client name should be selected from
