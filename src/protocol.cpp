...
// 808 message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xcd, 0xbe, 0xb4, 0xdc };
static unsigned char pchMessageStart808[4] = { 0xc6, 0xd5, 0xe3, 0xcb };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStart808 : pchMessageStartBitcoin, sizeof(pchMessageStart808));
}
