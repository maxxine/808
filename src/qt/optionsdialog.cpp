        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start 808 on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start 808 after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the 808 client port on the router. This only works when your router supports UPnP and it is enabled."));
    ...
    QLabel *fee_help = new QLabel(tr("Mandatory network transaction fee per kB transferred. Most transactions are 1 kB and incur a 0.01 808 fee. Note: transfer size may increase depending on the number of input transactions required to be added together to fund the payment."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show 808 addresses in the transaction list"));
